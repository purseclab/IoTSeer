...
% delta = 0.1; 
%       Delta parameter 
%       For details, see: Abbas et al. Robustness-Guided Temporal Logic 
...
% proposalMethod = 'hit-and-run';  % Currently not supported
...
%
% E.g., to change sa_cold_stoch.J_bound type:
%
...
classdef SA_Cold_Stoch_parameters
    ...
    methods
        ...
        function obj = SA_Cold_Stoch_parameters(varargin)
            if nargin>0
                error(' SA_Cold_Stoch_parameters : Please access directly the properties of the object.')
            end
        end
