...
4. Toolboxes required for the motion planning demos:
	...
	2) Multi Parametric Toolbox (https://www.mpt3.org/)
4. Toolboxes required for running searches over arbitrary convex spaces or over time-space input parameterizations:
	2) Multi Parametric Toolbox (https://www.mpt3.org/)
...
History is not being updated any more. Please review the SVN commit list:
https://www.assembla.com/spaces/s-taliro_public/subversion/commits/list
for current status and version. If you would like to refer to a specific version of S-TaLiRo, please refer to the SVN commit number.
