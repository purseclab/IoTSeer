...
% Uniform Random Sampling as a sampler
...
disp(' ')
disp(' Demo: Uniform Random Sampling on the aircraft example from the HSCC 2010 paper. ')
disp(' Two runs will be performed for a maximum of 200 tests each. ')
