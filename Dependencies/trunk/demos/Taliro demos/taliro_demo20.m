...
% The distance metric computes also the distance to the guards.
...
% Guards contains the guards that enable the transitions between control
% locations

disp(' ')
disp('Running dp_taliro ... ')
tic
rob_dp = dp_taliro(phi,Pred,hh1(:,3:6),hh1(:,2),hh1(:,1),CLG,Guards)
toc
disp(' ')
disp('Running fw_taliro ... ')
tic
rob_fw = fw_taliro(phi,Pred,hh1(:,3:6),hh1(:,2),hh1(:,1),CLG,Guards)
toc
