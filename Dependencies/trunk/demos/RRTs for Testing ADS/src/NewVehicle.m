%NewVehicle Abstract vehicle class
%
% WE USE THIS CLASS INSTEAD OF Vehicle FROM ROBOTICS TOOLBOX BECAUSE THE
% NUMBER OF STATES IS HARDCODED AS 3 IN THE Vehicle CLASS.
%
...
classdef NewVehicle < handle
    ...
    methods
        ...
        function veh = NewVehicle(varargin)
