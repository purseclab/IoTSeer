...
tt = datetime('now');
if keep_global_cost_at_nodes
    fname = ['../log/rrtstar_many_cars_global_',num2str(tt.Year),num2str(tt.Month),num2str(tt.Day),'_',num2str(tt.Hour),'_',num2str(tt.Minute)]
else
    fname = ['../log/rrtstar_many_cars_local_',num2str(tt.Year),num2str(tt.Month),num2str(tt.Day),'_',num2str(tt.Hour),'_',num2str(tt.Minute)]
end
save(fname);
