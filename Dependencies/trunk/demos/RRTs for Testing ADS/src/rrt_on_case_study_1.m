...
tt = datetime('now');
if keep_global_cost_at_nodes
    fname = ['../log/rrt_global_',num2str(tt.Year),num2str(tt.Month),num2str(tt.Day),'_',num2str(tt.Hour),'_',num2str(tt.Minute)]
else
    fname = ['../log/rrt_local_',num2str(tt.Year),num2str(tt.Month),num2str(tt.Day),'_',num2str(tt.Hour),'_',num2str(tt.Minute)]
end
save(fname);
