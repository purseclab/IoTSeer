...
%
% This demo uses hybrid distances. In order to use hybrid distances, the 
% map2line option must be disabled.
%
% See <a href="matlab: doc staliro_options.map2line">doc staliro_options.map2line</a>.
%
% Not all stochastic optimizers support optimization over hybrid distances. 
% Please check the documentation for the optimizers that support directly 
% optimization over hybrid distance metrics. If an optimizer does not support
% a hybrid distance metric, then the option map2line must be used.
%
...
%
% See also : staliro_demo_autotrans_03.m
